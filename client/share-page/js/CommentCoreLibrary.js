...
var CoreComment = (function () {
    function CoreComment(parent, init) {
        ...
        if (init.hasOwnProperty("nickname")) {
            this.nickname = init["nickname"];
        }
        if (init.hasOwnProperty("avatarClassName")) {
            this.avatarClassName = init["avatarClassName"];
        }
        if (init.hasOwnProperty("nicknameClassName")) {
            this.nicknameClassName = init["nicknameClassName"];
        }
        if (init.hasOwnProperty("divClassName")) {
            this.divClassName = init["divClassName"];
        }
        if (init.hasOwnProperty("textClassName")) {
            this.textClassName = init["textClassName"];
        }
    ...
    CoreComment.prototype.init = function (recycle) {
        ...
        if(this.avatar && this.nickname){
            ...
            imageObj.src = this.avatar;
            imageObj.className = this.avatarClassName;
            this.dom.appendChild(imageObj);   
            var messageObj = document.createElement('div');
            messageObj.className = this.divClassName;
            var nameObj = document.createElement('div');
            nameObj.className = this.nicknameClassName;
            nameObj.textContent = this.nickname;
            var textObj = document.createElement('div');
            textObj.className = this.textClassName;
            textObj.textContent = this.text;
            messageObj.appendChild(nameObj);
            messageObj.appendChild(textObj);
            this.dom.appendChild(messageObj);   
        }else{
